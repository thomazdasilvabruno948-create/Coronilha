...
export default function App() {
  ...
  if (pagina) {
    return (
      <main>
        <header className="nav"><div className="marca">CORONILHA<span> NEGÓCIOS RURAIS</span></div><nav><a href="#catalogo" onClick={() => { setPagina(null); setCategoria("Campos"); }}>Campos</a><a href="#catalogo" onClick={() => { setPagina(null); setCategoria("Gados"); }}>Gado</a><a href="#sobre" onClick={() => setPagina(null)}>Sobre nós</a><a href="#contato" onClick={() => setPagina(null)}>Entre em contato</a></nav></header>
  ...
  return (
    <main>
      <header className="nav"><div className="marca">CORONILHA<span> NEGÓCIOS RURAIS</span></div><nav><a href="#catalogo" onClick={() => setCategoria("Campos")}>Campos</a><a href="#catalogo" onClick={() => setCategoria("Gados")}>Gado</a><a href="#sobre">Sobre nós</a><a href="#contato">Entre em contato</a></nav></header>
