...
export default function App() {
  ...
  if (pagina) {
    return (
      <main>
        <header className="nav"><div className="marca">CORONILHA<span> NEGÓCIOS RURAIS</span></div><nav><a href="#inicio" onClick={() => setPagina(null)}>Início</a><a href="#catalogo" onClick={() => setPagina(null)}>Catálogo</a><a href="#sobre" onClick={() => setPagina(null)}>Sobre nós</a><a href="#contato" onClick={() => setPagina(null)}>Contato</a></nav></header>
