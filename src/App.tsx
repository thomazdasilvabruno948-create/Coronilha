...
export default function App() {
  ...
  return (
    <main>
      ...
      <section id="inicio" className="hero hero-centered"><div className="hero-copy"><div className="hero-logo">CORONILHA</div><h1>Coronilha, negócios rurais</h1><p>Imóveis selecionados para quem valoriza localização, qualidade e tranquilidade.</p><a className="button" href="#catalogo">Explorar imóveis</a></div></section>
